...
Инвентарь собран по `package.json`, skill-именам, feature-guides, корневой документации и служебным скриптам. Основной вывод: бренд `k-skill` уже не доминирует на верхнем уровне, а часть критичных migration-пунктов уже закрыта через слой совместимости, но несколько legacy surface area всё ещё нельзя переименовать без явного migration plan.
