...
- Нужен список отделений по городу без ручного разбора через обозреватель
...
- система непрерывной интеграции опирается на разметку HTML на основе эталонных данных, а не на актуальную вёрстку
