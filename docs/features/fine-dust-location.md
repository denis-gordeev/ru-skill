...
- Публичный proxy и устаревшее именование здесь остаются слоем совместимости, а не рекомендацией расширять `ru-skill` новыми корейскими сценариями источников данных.
