...
- Никакие ключи программного интерфейса, маркеры доступа или посредники не нужны
...
| Карточка товара | Адрес из результатов поиска | `getProduct("https://market.yandex.ru/card/...")` |
...
- Это не официальный публичный программный интерфейс, а интерфейс разметки HTML Яндекс Маркета
