...
`yandex-market-search` — это клиент только для чтения для поиска товаров и чтения карточек товаров на публичных серверно отрендеренных страницах Яндекс Маркета. Он нужен как российская замена устаревшего навыка `daiso-product-search`.
