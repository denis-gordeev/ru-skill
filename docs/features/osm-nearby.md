...
- Требуется бесплатное решение без API-ключа для поиска ближайших в российских городах
...
- **Качество данных варьируется** — в Москве и Петербурге покрытие хорошее, в малых городах может быть неполным
- **Не все поля заполнены** — телефон, сайт, часы работы зависят от участников OSM

## Альтернативы для промышленного использования
...
`osm-nearby` — лучший бесплатный вариант без API-ключа для базового поиска ближайших.
