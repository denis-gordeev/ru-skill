...
- Требуется бесплатное решение без API-ключа для nearby-поиска в российских городах
...
`osm-nearby` — лучший бесплатный вариант без API-ключа для базового nearby-поиска.
