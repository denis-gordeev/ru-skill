...
- Требуется бесплатное решение без ключа API для поиска ближайших в российских городах
- Не нужны рейтинги и отзывы (для них подойдут 2GIS/Яндекс.Карты с ключом API)
...
- **2GIS API** — лучшие данные для российских городов, но требует ключ API и платную лицензию
- **Яндекс.Карты Places API** — отлично для встроенных карт, но результаты должны отображаться на Яндекс.Карте

`osm-nearby` — лучший бесплатный вариант без ключа API для базового поиска ближайших.
