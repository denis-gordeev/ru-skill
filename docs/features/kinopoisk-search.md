...
Тесты используют подход на основе эталонных данных с сохранёнными HTML-страницами Кинопоиска, чтобы система непрерывной интеграции не зависела от живой вёрстки kinopoisk.ru.
