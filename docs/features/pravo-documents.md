...
`pravo-documents` - это обёртка только для чтения над официальным программным интерфейсом портала правовой информации для поиска федеральных законов, постановлений и других правовых актов с получением нормализованных метаданных документа.
...
- Источник данных: официальный программный интерфейс `https://publication.pravo.gov.ru/api/`
- Программный интерфейс не поддерживает полнотекстовый поиск с булевыми операторами
