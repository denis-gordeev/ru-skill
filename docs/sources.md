...
- Сценарий остаётся только для чтения и не требует входа, токенов или посредника.
...
- Полноценный нечёткий поиск по произвольной строке, если он потребует нестабильного JS-автокомплита.
...
- Минимальный рабочий вариант можно собрать на устойчивых HTML-интерфейсах списка предупреждений и карточки предупреждения.
...
- Wildberries API требует токен продавца (dev.wildberries.ru), а публичная выдача быстро уходит в антибот-поток.
