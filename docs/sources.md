...
- Технический baseline: skill + небольшой пакет только для чтения с на основе эталонных данных тестом на нормализацию XML.
...
- Технический baseline: skill + пакет только для чтения + на основе эталонных данных тесты на JSON-нормализацию ISS.
...
- Технический baseline: skill + пакет только для чтения + на основе эталонных данных тесты на HTML-нормализацию страниц `cities` и `offices`.
...
- Технический baseline: skill + пакет только для чтения + на основе эталонных данных JSON-тесты.
...
- Технический baseline: skill + пакет только для чтения + на основе эталонных данных тесты на HTML-нормализацию страниц архива.
...
- Технический baseline: skill + пакет только для чтения + на основе эталонных данных тесты на HTML-нормализацию.
...
- Технический baseline: skill + пакет только для чтения + на основе эталонных данных HTML-тесты для списка предупреждений и одной карточки.
...
- Технический baseline: skill + пакет только для чтения + на основе эталонных данных JSON-тесты на ответы API.
...
- Технический baseline: skill + пакет только для чтения + на основе эталонных данных HTML-тесты.
