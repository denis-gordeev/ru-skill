...
- Zoon.ru — публичный справочник организаций, серверно отрендеренные страницы (SSR), без антибота, без API keys.
...
Этот блок сохранён для справки, поскольку текущие regression-тесты и часть устаревшей документации опираются на эти источники.
