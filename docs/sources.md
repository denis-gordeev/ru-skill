...
- Для первого нового навыка не нужен прокси или обход нестабильного веб-интерфейса.
...
- Сценарий остаётся только для чтения и не требует логина, токенов или прокси.
...
- Для минимального рабочего варианта не нужен вход, пользовательские секреты, прокси или операции записи.
...
- На текущем этапе поисковая выдача и карточки товаров доступны как HTML, сгенерированный на сервере, который можно нормализовать без браузерной автоматизации и без ключа API.
...
- Для прокси-интерфейсов приоритет у бесплатных API и официальных открытых данных.
