...
- На текущем этапе поисковая выдача и карточки товаров доступны как HTML, сгенерированный на сервере, который можно нормализовать без браузерной автоматизации и без API-ключа.
...
- Zoon.ru — публичный справочник организаций, страницы с серверной отрисовкой (SSR), без антибота, без API-ключей.
