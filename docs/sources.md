...
- Для минимального рабочего варианта не нужны логин, пользовательские секреты, прокси или операции записи.
...
- Минимальный рабочий вариант можно собрать на устойчивых HTML-поверхностях списка предупреждений и карточки предупреждения.
...
- Price.ru и E-katalog остаются резервными кандидатами, если текущая серверно отрендеренная поверхность (SSR) Яндекс Маркета перестанет быть доступной.
...
- Для прокси-поверхностей приоритет у бесплатных API и официальных открытых данных.
