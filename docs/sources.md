...
- Публичный API только для чтения доступен без пользовательской проверки подлинности для поисковых сценариев.
...
- API полностью только для чтения и публичный, без проверки подлинности, маркеров доступа и пользовательских секретов.
...
- Это бесплатный публичный API без необходимости ключа API или проверки подлинности.
