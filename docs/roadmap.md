...
| `moex-shares` | `target` | Публичные метаданные и delayed-цены акций Московской биржи | Базовый навык только для чтения по российскому фондовому рынку | Реализован |
