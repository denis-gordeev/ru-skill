...
3. Выбрать седьмой российский read-only источник, чтобы target-линейка продолжала расти за пределами финансов, лотерей, почтовых индексов, рынка труда и кино.
