...
- Если нужен новый российский железнодорожный сценарий: в target-линейке для этого базовым путём считается `yandex-rasp`, а не расширение legacy-booking навыков.
