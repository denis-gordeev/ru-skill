...
- В `docs/roadmap.md` обновлён статус Milestone 4: документная миграция, матрица замен и маркировка legacy-пакетов доведены до рабочего завершения; дальше фокус смещён на booking-replacements и релиз-гигиену.
...
- Держать в CI синхрон README, roadmap, TODO, booking docs и метаданные пакетов descriptions, чтобы закрытые milestone не возвращались в активный backlog из-за документного дрейфа.
