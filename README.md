...
- Подготовить release-hygiene раунд: проверить changeset inventory, выровнять формулировки merge-ready статуса и не допускать устаревших round-summary в живых документах.
