...
- PyPI trusted publishing сейчас безопаснее не использовать внутри повторно используемого процесса.
- Фактический `pypi-publish` job следует оставлять в верхнеуровневом процессе, как сейчас.
