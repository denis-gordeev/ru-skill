...
description: Отслеживание посылок CJ Logistics и Почтовой службы Кореи по номеру накладной через официальные эндпоинты перевозчиков. Структура построена вокруг адаптера перевозчика, который в будущем можно расширить на другие курьерские службы.
license: MIT
metadata:
  category: logistics
  locale: ru-RU
