...
- Предпочтительные артефакты выполнения для проверок обновлений и журналов: `~/.config/ru-skill/bin` и `~/.config/ru-skill/logs`

Оба имени должны вести к одному и тому же потоку настройки без нарушений при миграции.
