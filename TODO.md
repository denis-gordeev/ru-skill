...
- [ ] Продолжить такой же аудит уже по историческим секциям `TODO.md`, где ещё остались старые гибриды из ранних раундов.
- [ ] Проверить верхнеуровневые документы на следующий слой смешения вокруг англоязычных имён инструментов и служебных меток релизного контура, не трогая кодовые идентификаторы.
