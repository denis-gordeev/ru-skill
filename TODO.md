...
- Выявлены и устранены остаточные жаргонизмы: `рыночные снимки` → `рыночные срезы` в `packages/moex-shares/README.md` (1 вхождение), `Антибот` → `Защита от ботов` в `docs/features/zoon-nearby.md` (1 вхождение).

## Выполнено в этом раунде (раунд 92)

- [x] `packages/moex-shares/README.md`: `задержанные рыночные снимки` → `задержанные рыночные срезы`.
- [x] `docs/features/zoon-nearby.md`: `Антибот` → `Защита от ботов` в технических деталях.
