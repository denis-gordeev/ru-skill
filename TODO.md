...
- Периодический аудит выявил: `PR` без русского раскрытия в `docs/sources.md` (2 вхождения: `PR #54` → `запрос на слияние #54`); все устранены.
- Остальные ключевые жаргонизмы не вернулись в интерфейсной документации.

## Выполнено в этом раунде (раунд 121)

- [x] `docs/sources.md`: `PR #54` → `запрос на слияние #54` (2 вхождения, строки 21 и 515).
- [x] Периодический аудит интерфейсной документации: ключевые жаргонизмы не вернулись; `PR` без русского раскрытия устранён.
...
- [x] Проведено исследование российских брокерских и инвестиционных программных интерфейсов: MOEX ISS уже покрывается через `moex-shares`, T-Invest требует аккаунт.
