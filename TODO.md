...
- Выявлены и устранены гибридные термины и калки: `push-уведомления` → `уведомления push` (2 вхождения в `docs/sources.md`), `дата-диапазон` → `диапазон дат` (2 вхождения в `docs/sources.md` и `docs/features/pravo-documents.md`).

## Выполнено в этом раунде (раунд 90)

- [x] `docs/sources.md`: `push-уведомления` → `уведомления push` (2 вхождения), `дата-диапазон` → `диапазон дат`.
- [x] `docs/features/pravo-documents.md`: `дата-диапазон` → `диапазон дат`.
