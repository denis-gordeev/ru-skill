...
- Подтверждённый сценарий здесь именно про остатки для самовывоза, то есть pickup stock.
