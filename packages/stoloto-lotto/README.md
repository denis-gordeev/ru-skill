...
- Разбор HTML-страниц через извлечение регулярными выражениями, аналогично `postcalc-postcodes`.
...
Тесты используют подход на основе эталонных данных с сохранёнными HTML-страницами архива, чтобы система непрерывной интеграции (CI) не зависела от живой вёрстки stoloto.ru.
