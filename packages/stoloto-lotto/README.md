...
- Парсинг HTML-страниц через извлечение регулярными выражениями, аналогично `postcalc-postcodes`.
...
Тесты используют подход на основе эталонных данных с сохранёнными HTML-страницами архива, чтобы CI не зависел от живой вёрстки stoloto.ru.
