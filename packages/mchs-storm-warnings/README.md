...
Поиск региона по названию или имени узла, возвращает нормализованные имя узла и полное название.
...
- `query`: название региона или имя узла (например `"Курская область"`, `"Москва"`, `"46"`, `"moscow"`)
...
- `regionHost`: имя узла региона МЧС, например `46`, `78`, `moscow`, или название региона вроде `"Курская область"`
