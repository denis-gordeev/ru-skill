/**
 * Соответствие названий российских регионов их региональным именам узлов МЧС.
 *
 * Источники:
 ...
 *
 * Числовые имена узлов соответствуют подобным OKATO региональным кодам, используемым системы управления контентом (CMS) МЧС.
 * Именованные имена узлов используются для городов федерального значения и особых случаев.
 */
...
/**
 * Поиск региона по названию или имени узла, возвращает нормализованное имя узла.
 * @param {string} query - Название региона или имя узла (например "Москва", "moscow", "46", "Курская область")
...
/**
 * Возвращает список всех доступных регионов с названиями и именами узлов.
