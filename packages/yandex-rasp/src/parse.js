/**
 * Утилиты нормализации ответов программного интерфейса Яндекс Расписаний.
 * Основная нормализация происходит в index.js; этот модуль
 * предоставляет переиспользуемые утилиты для проверки корректности и форматирования.
 */
