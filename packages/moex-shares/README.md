...
Клиент только для чтения для публичного программного интерфейса ISS Московской биржи: метаданные акций и задержанные срезы рынка.
...
- Программный интерфейс ISS доступен только для чтения и публично доступен без секретов.
