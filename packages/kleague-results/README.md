...
`kleague-results` - устаревший клиент только для чтения для официальных K League JSON адресов. Пакет отдаёт результаты матчей по дате и текущую таблицу, не прибегая к HTML scraping.
