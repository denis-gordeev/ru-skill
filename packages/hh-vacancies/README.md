...
Клиент только для чтения для публичного программного интерфейса hh.ru: поиск вакансий, карточки вакансий и справочник регионов.
...
- Документация программного интерфейса: `https://api.hh.ru/openapi/redoc`
...
- Публичный программный интерфейс hh.ru — только для чтения в этих сценариях и не требует пользовательских секретов.
