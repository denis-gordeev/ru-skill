...
Клиент только для чтения для поиска ближайших заведений через публичный программный интерфейс Overpass OpenStreetMap.

## Возможности

- Поиск ближайших ресторанов, кафе, баров и других заведений по координатам
- Бесплатный доступ, без ключа программного интерфейса
