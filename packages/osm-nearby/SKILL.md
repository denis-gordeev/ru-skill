---
name: osm-nearby
description: Поиск ближайших заведений (рестораны, кафе, бары) через публичный Overpass API OpenStreetMap без ключа программного интерфейса и проверки подлинности.
license: MIT
metadata:
  category: еда
  locale: ru-RU
