---
name: osm-nearby
description: Поиск ближайших заведений (рестораны, кафе, бары) через публичный Overpass API OpenStreetMap без ключа API и авторизации.
license: MIT
metadata:
  category: еда
  locale: ru-RU
...
- Работать без ключа API и без авторизации
