...
Публичный клиент только для чтения для поиска фильмов и просмотра карточек фильмов на Кинопоиске.

## Что делает навык

- Получать карточку фильма по идентификатору Кинопоиска: название, год, рейтинг, описание, жанры, режиссёр, актёры.
- Искать фильмы по названию или ключевым словам.
- Работать без проверки подлинности, секретов и посредника.
...
- Это публичные веб-страницы Кинопоиска, без отдельного программного интерфейса в архитектурном стиле REST.
