...
Клиент только для чтения для официальных правовых документов через программный интерфейс портала pravo.gov.ru.
...
- Все запросы направляются к официальному программному интерфейсу pravo.gov.ru.
...
Тесты используют подход на основе эталонных данных с сохранёнными результатами поиска и карточками документов, чтобы система непрерывной интеграции (CI) не зависела от живых ответов программного интерфейса.
