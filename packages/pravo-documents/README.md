...
Тесты используют подход на основе эталонных данных с сохранёнными результатами поиска и карточками документов, чтобы CI не зависел от живых ответов API.
