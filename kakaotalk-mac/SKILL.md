...
Этот навык остаётся на `устаревший без развития` границе. Он поддерживается как локальная macOS-эталон автоматизации и для обратной совместимости, но не рассматривается как новое русскоязычное целевое направление обмена сообщениями или скрытый перечень задач.
