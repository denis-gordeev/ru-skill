...
3. **Сначала `~/.config/ru-skill/secrets.env`**, при отсутствии — устаревший резерв **`~/.config/k-skill/secrets.env`**. Оба файла предполагают формат plain dotenv и права `0600`.
