---
name: k-skill-setup
description: Legacy-совместимый навык настройки для ru-skill, который настраивает общие секреты и проверки времени выполнения; для новых установок предпочтителен `ru-skill-setup`.
license: MIT
metadata:
  category: setup
  locale: ru-RU
