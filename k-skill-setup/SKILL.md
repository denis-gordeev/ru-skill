...
`k-skill-setup` сохраняется как legacy-совместимый псевдоним. Для новых установок в документации рекомендуется имя `ru-skill-setup`, но сам поток настройки остаётся общим.
