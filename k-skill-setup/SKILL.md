...
2. **Если агент использует собственное хранилище секретов** (`1Password CLI`, `Bitwarden CLI`, Связка ключей macOS и т.д.), извлечь оттуда и передать как переменную окружения.
